            ...
            <div className="flex items-center justify-between gap-3">
              <span className="flex items-center gap-2 text-sm text-gray-600">
                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-blue-50">
                  <IconDroplet stroke={1.5} className="w-4 h-4 text-blue-500" />
                </span>
                Umidade
              </span>
          ...
          {favCondition ? (
            <div className="bg-green-100 flex flex-col rounded-sm p-3 gap-2">
              <div className="">
                ...
                <p className="text-gray-600 pl-7">Janela ideal até as 18:00</p>
              </div>

              <Button className="bg-white/80 text-green-700 transition duration-300 ease-in-out hover:scale-105 hover:bg-white">
